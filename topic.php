...
<div class="content"><!--Content Area Starts-->
    ...
    <div id="content_timeline"><!--Content_timeline Starts-->
       ...
       <input type="text" name="title" placeholder="Write a Title" size="73" required="required"></br></br>
       <textarea cols="71" rows="4" name="content" placeholder="Write description"></textarea></br></br>
       <select name="topic">
