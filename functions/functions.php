...
echo "<h3>Posted to timeline, Looks Awesome!</h3>";
...
<textarea cols='50' rows='5' name='comment' placeholder='write yor reply'></textarea></br>
...
echo "<h2>Your Comment was Added</h2>";
...
//function for gettiong the categories or topics
function get_Cats() {
